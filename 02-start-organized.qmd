...
It would be quite the task for this book to cover every method of checking and cleaning data. The next best is to describe what to do next in the remaining chapter and how to discover data validating and cleaning methods in the following @sec-learn-as-you-go. The most difficult data to clean is text data. Please see @sec-text-data to prepare for it.
